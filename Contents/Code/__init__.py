...
SHOWS_URL = 'http://www.mylifetime.com/shows'
VIDEO_URL = 'http://www.mylifetime.com/videos'
MOVIE_URL  = 'http://www.mylifetime.com/videos/movies'

EPISODES = 'https://mediaservice.aetndigital.com/SDK_v2/show_titles/episode/mlt?show_name=%s'
CLIPS = 'https://mediaservice.aetndigital.com/SDK_v2/show_titles/clip/mlt?show_name=%s'

RE_SEASEP =  Regex('S(\d+) E(\d+)')

OLD_SHOWS_API = 'http://wombatapi.aetv.com/shows2/mlt'
...
def MainMenu():
    ...
    oc.add(DirectoryObject(key=Callback(HTMLSection, title="Movies", url=MOVIE_URL, section_type='all-movies'), title="Movies"))
    return oc

####################################################################################################
# This function produces the items in a section of a web page
